...
# Overview
RedEye is a metadata scraping tool for use in cross sectional surveys, and is designed with accessibility for users with limited programming expertise in mind. By leveraging multi-threading, it is able to rapidly extracted author linked metadata (ie; author emails, institutions, etc...) from a provided list of PMIDs or an OVID output file. Via these methods, the contact information of tens of thousands of authors can be extracted within minutes. To learn how to use RedEye, please see the attached [tutorial](RedEye_Tutorial.md)
